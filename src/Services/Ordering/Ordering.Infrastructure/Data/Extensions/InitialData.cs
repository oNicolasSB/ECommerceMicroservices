...
public class InitialData
{
    ...
    [
        Customer.Create(CustomerId.Of(new Guid("58c49479-ec65-4de2-86e7-033c546291aa")), "customer1", "customer1@email.com"),
        Customer.Create(CustomerId.Of(new Guid("189dc8dc-990f-48e0-a37b-e6f2b60b9d7d")), "customer2", "customer2@email.com")
    ];

    public static IEnumerable<Product> Products =>
    [
        Product.Create(ProductId.Of(new Guid("5334c996-8457-4cf0-815c-ed2b77c4ff61")), "IPhone X", 500),
        Product.Create(ProductId.Of(new Guid("c67d6323-e8b1-4bdf-9a75-b0d0d2e7e914")), "Samsung S10", 400),
    ...
    public static IEnumerable<Order> Orders
    {
        get
        {
            var address1 = Address.Of("customer1", "lastname1", "customer1@email.com", "Bahcelievler No:4", "Turkey", "Istanbul", "38050");
            var address2 = Address.Of("customer2", "lastname2", "customer2@email.com", "Broadway No:1", "England", "Nottingham", "08050");

            var payment1 = Payment.Of("customer1", "5555555555554444", "12/28", "355", 1);
            var payment2 = Payment.Of("customer2", "8885555555554444", "06/30", "222", 2);
